...
class KeithleySourceMeterComponent(HardwareComponent): #object-->HardwareComponent
    ...
    def setup(self):
        ...
        self.source_delay_time_a = self.settings.New('source_delay_time_a', float, spinbox_decimals = 3, unit='sec')
    ...
    def connect(self):
        ...
        self.source_delay_time_a.connect_to_hardware(lambda: K.read_source_delay(),
                    lambda delay:K.write_source_delay(delay))
